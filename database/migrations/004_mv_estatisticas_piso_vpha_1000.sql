-- =====================================================================
-- 004: Eleva piso de vpha de R$ 50/ha para R$ 1.000/ha
-- =====================================================================
-- Motivo: valores abaixo de R$ 1.000/ha sao quase sempre erros de parsing
-- do robo (unidade alqueire/m^2 confundida com ha, virgula decimal lida
-- como separador de milhar). Terra rural no Brasil -- mesmo em Amazonia
-- profunda -- raramente e negociada abaixo disso.
--
-- Reversivel: reaplique 003 para voltar ao piso de R$ 50/ha.
