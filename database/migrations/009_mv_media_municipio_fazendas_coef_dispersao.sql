-- =====================================================================
-- 009: Adiciona coeficiente de dispersao (%) em mv_media_municipio_fazendas
-- =====================================================================
-- Motivo: o coef_dispersao_pct (stddev/avg * 100) existia em
-- mv_estatisticas_simet mas nao foi trazido pra cá. E util pra
-- estimar a confiabilidade de cada mediana/media: quanto maior
-- o coef, mais voláteis os vpha no grupo.
--
-- Como as medianas e medias, o coef_dispersao tambem faz fallback
-- por tipologia (pega do vizinho mais similar que tenha anuncios
-- daquela tipologia).
...
LEFT JOIN LATERAL (
    ...
    ORDER BY
        CASE
            ...
            WHEN c.reg_id = m.reg_id THEN 2 ELSE 3
        END,
